...
var MapsLib = {
  ...
  doSearch: function(location) {
    ...
    var tempWhereClause = [];
    if ( $("#FeeBox").is(':checked')) tempWhereClause.push("YES");
    if ( $("#NoFeeBox").is(':checked')) tempWhereClause.push("NO");
    whereClause += " AND " + type_column + " IN ('" + tempWhereClause.join("','") + "')";

    //for checkbox
    var type_column = "'Device'";
    var tempWhereClause = [];
    if ( $("#ATMbox").is(':checked')) tempWhereClause.push("ATM");
    if ( $("#POSbox").is(':checked')) tempWhereClause.push("POS");
    whereClause += " AND " + type_column + " IN ('" + tempWhereClause.join("','") + "')";

    // For using dropdown
    //if ( $("#device_type").val() != "")
    //   whereClause += " AND 'type' = '" + $("#device_type").val() + "'";
